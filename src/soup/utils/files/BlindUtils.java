...
public class BlindUtils {
    ...
    public static void BlindFiles(File file, String separateFolder, String ext, String inExt, boolean onlyUseInputFolders){
        ...
        blind(CenterController.getCenterController(),out,files,sub,subFolder,ext);
    }
